...
// Please declare the class Car and define the following fields of this class
// (with the access modifier private): model, brand,
...
//We also create methods to return each of the fields (we use return)
// e.g.: getMOdel () and methods to set value each of the
//fields (methods taking a new value in their parameters fields) e.g.: setModel (Sting model).


//Additionally, we create a delivery() method (simulating car delivery)
// and sell() (simulating car sales) which change the value
...
// Class should be defined by a single entity , you can have classes like a name or an age
